    ...
    start(port) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                this._portsConfigStore.configApiUrl = yield this._expressServer.listen(port);
...
ConfigServer = __decorate([
    ...
    __param(0, inversify_1.inject(dependency_injection_types_1.TYPES.IExpressServerFacade)),
    __param(1, inversify_1.inject(dependency_injection_types_1.TYPES.IConfigController)),
    __param(2, inversify_1.inject(dependency_injection_types_1.TYPES.IPortsConfigStore)),
